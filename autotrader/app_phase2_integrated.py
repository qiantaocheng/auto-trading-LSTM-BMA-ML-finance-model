...
# === 新集成的功能模块 ===
from .adaptive_weights_adapter import get_adaptive_weights
from .unified_monitoring_adapter import get_monitoring_adapter  
from .order_validation_adapter import get_order_validator
from .enhanced_logging_adapter import get_enhanced_logger
# === 第二阶段集成模块 ===
from .realtime_alpha_adapter import get_alpha_engine
from .unified_factor_manager_adapter import get_factor_manager
from .enhanced_risk_manager_adapter import get_risk_manager
from .prediction_calibrator_adapter import get_prediction_calibrator
...
class AutoTraderGUI(tk.Tk):
    def __init__(self) -> None:  # type: ignore
        ...
        self.monitoring_adapter = get_monitoring_adapter()
        self.order_validator = get_order_validator() 
        self.enhanced_logger = get_enhanced_logger()
        
        # 记录系统启动
        self.enhanced_logger.log_system_error(Exception("系统启动"), "startup")
        self.monitoring_adapter.update_performance("system_startup", 1.0)
        ...
        # 记录第二阶段模块启动
        self.enhanced_logger.log_system_error(Exception("第二阶段模块已加载"), "phase2_startup")
        self.monitoring_adapter.update_performance("phase2_modules_loaded", 1.0)
